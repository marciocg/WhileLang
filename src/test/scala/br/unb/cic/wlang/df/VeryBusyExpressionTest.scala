...
import br.unb.cic.wlang.df.framework.{ VeryBusyExpression => MFPVBE, VeryBusyExpressionRep => MFPVBERep }
 ...
 */  
  ...
  test("Test case for the MFP implementation of Very Busy Expressions") {
    ...
    test("Test case for the MFP Reimplementation of Very Busy Expressions") {

    val mfp = new MFPVBERep(p)
