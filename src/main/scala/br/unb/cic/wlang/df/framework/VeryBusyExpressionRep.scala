...
import br.unb.cic.wlang.WhileProgram.{Label, assignments, block, nonTrivialExpression, expHasVariable}

class VeryBusyExpressionRep(wp: WhileProgram) extends MFP[Exp](wp) {
